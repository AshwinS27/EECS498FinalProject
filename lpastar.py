...
class Lpastar:
        ...
        while 1:
            ...
            if self.myrobot.does_conflict_with_path(new_obs_points, curr_path, curr_path_idx):
                ...
                if self.debug:
                    ...
                    path_marker_ids = plot_points(
                        curr_path, color=(1, 1, 1, 1))
    ...
    def lpastar(self, start_state):
        ...
        start_node = Node(start_state, unique_id, -1,
                          dist(start_state, self.goal_state), 0)
        unique_id += 1
        ...
        while not frontier.empty():
            ...
            new_node = Node(new_state, unique_id, curr_node.getId(), dist(
                new_state, self.goal_state), curr_node.getG() + dist(curr_state, new_state))
            ...
            new_node2 = Node(new_state2, unique_id, curr_node.getId(), dist(
                new_state2, self.goal_state), curr_node.getG() + dist(curr_state, new_state2))
            ...
            new_node3 = Node(new_state3, unique_id, curr_node.getId(), dist(
                new_state3, self.goal_state), curr_node.getG() + dist(curr_state, new_state3))
            ...
            new_node4 = Node(new_state4, unique_id, curr_node.getId(), dist(
                new_state4, self.goal_state), curr_node.getG() + dist(curr_state, new_state4))
            ...
            new_node5 = Node(new_state5, unique_id, curr_node.getId(), dist(
                new_state5, self.goal_state), curr_node.getG() + dist(curr_state, new_state5))
            ...
            new_node6 = Node(new_state6, unique_id, curr_node.getId(), dist(
                new_state6, self.goal_state), curr_node.getG() + dist(curr_state, new_state6))
